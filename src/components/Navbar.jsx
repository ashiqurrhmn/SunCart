      ...
      <nav className=" flex justify-between items-center  py-3 w-9/12 mx-auto">
        ...
        <div className="hidden md:flex items-center gap-3">
          <ul className="flex items-center font-semibold text-sm gap-2">
            ...
            <li>
              <Link className="hover:bg-orange-400 bg-orange-500 text-white px-3 py-2 rounded-2xl" href={"/register"}>Register</Link>
            </li>
          </ul>
        </div>
       ...
       {open && (
        <div className="md:hidden flex flex-col items-center  bg-white border-t px-4 py-4 space-y-3 text-sm">
          ...
          <Link href="/all-products" onClick={() => setOpen(false)}>Products</Link>
          <Link href="/profile" onClick={() => setOpen(false)}>My Profile</Link>

          <div className="pt-2 flex flex-col gap-2">
            <Link className="bg-gray-300 text-black px-3 py-2 rounded-2xl text-center" href="/signin">
              SignIn
            </Link>
            <Link className="bg-orange-500 text-white px-3 py-2 rounded-2xl text-center" href="/register">
              Register
            </Link>
          </div>
        </div>
